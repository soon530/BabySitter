...
import tw.tasker.babysitter.view.fragment.NavigationDrawerFragment;
import tw.tasker.babysitter.view.fragment.NavigationDrawerFragment.NavigationDrawerCallbacks;
...
*/	}
	...
	public void onSectionAttached(int number) {
		switch (number) {
		case 1:
			mTitle = getString(R.string.search_babysitter);
			break;
		case 2:
			mTitle = getString(R.string.rating_babysitter);
			break;
		case 3:
			mTitle = getString(R.string.social_babysitter);
			break;
		}
	}
